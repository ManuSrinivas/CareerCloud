...
namespace CareerCloudUI.Controllers
{
    public class ApplicantWorkHistorysController : Controller
    {
        ...
        public ActionResult Index(Guid? Id)
        {
			if (Id != null)
			{
				var applicantWorkHistories = db.ApplicantWorkHistories.Where(a => a.Applicant == Id);
				return View(applicantWorkHistories.ToList());
			}
			else
			{
				var applicantWorkHistories = db.ApplicantWorkHistories.Include(a => a.ApplicantProfile).Include(a => a.SystemCountryCode);
				return View(applicantWorkHistories.ToList());
			}
        }
